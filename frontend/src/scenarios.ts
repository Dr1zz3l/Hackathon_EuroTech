 ...
 * Stage 3 — adjacency weight added to all scenarios.
 *
 ...
 *
 * Adjacency weight rationale: scoring.ts re-normalises weights so the
 * existing AHP ratios are preserved; adjacency simply claims its proportional
 * share (same pattern as renewal in urban_renewal).
 * Green and Education get a stronger adjacency weight (corridor / cluster
 * narrative); Industrial and Urban Renewal get a lighter signal.
 * If adjacency.json is not loaded, scoring.ts silently ignores this field.
 *
